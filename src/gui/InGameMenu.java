...
public class InGameMenu extends JPanel {
	...
	/**
	 * This class creates the ingame menu
	 */
	private static final long serialVersionUID = -5087097357536792160L;
	...
	public InGameMenu() {
		...
		gridBagLayout.rowHeights = new int[] { 144, 0, 0, 0, 0, 0 };
		...
		button_exit.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				int action = JOptionPane.showConfirmDialog(InGameMenu.this,
